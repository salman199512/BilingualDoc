        ...
        $('#documents-table').DataTable({
            ...
            columns: [
                { data: 'title', name: 'title', render: function(data, type, row) {
                    return '<a href="/documents/' + row.id + '/edit" class="text-link" style="font-weight:600; font-size:0.92rem;">' + data + '</a>';
                }},
                { data: 'page_size', name: 'page_size' },
                { data: 'orientation', name: 'orientation', render: function(data) {
