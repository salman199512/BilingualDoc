...
<div class="card animate-fade-in">
    ...
    <form action="{{ route('templates.store') }}" method="POST" class="form-light" onsubmit="prepareTplSubmit(); showLoader();">
        ...
        <div class="template-builder-header-grid">
            <div>
                <div class="form-group">
                    ...
                    <input type="text" name="title" id="title" class="form-input" placeholder="e.g. Standard Bilingual Circular" required autofocus>
                    @error('title')
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="description" class="form-input" placeholder="What is this template used for?" rows="3"></textarea>
                </div>
            </div>
        ...
        <div class="form-group" style="margin-bottom: 2rem;">
            ...
            <input type="hidden" name="html_content" id="html_content" value="{{ old('html_content', '<div style="text-align: center; margin-bottom: 20px;"><h2>DEPARTMENT OF REVENUE &amp; FORESTS</h2><h3>મહેસૂલ અને વન વિભાગ</h3></div><div style="display: flex; justify-content: space-between; margin-bottom: 20px;"><div><strong>Circular No / પરિપત્ર ક્રમાંક:</strong> [[circular_no]]</div><div style="text-align: right;"><strong>Date / તારીખ:</strong> [[date]]</div></div><p><strong>SUBJECT: [[subject]]</strong></p><p>આથી તમામ કર્મચારીઓને જણાવવામાં આવે છે કે [[details]]</p>') }}">
            ...
            <div class="template-editor-wrapper" style="border: 1px solid var(--border-color); border-radius: 10px; overflow: hidden; background: #ffffff; box-shadow: var(--shadow-sm);">
                ...
                <div id="tpl-visual-editor" contenteditable="true" style="min-height: 320px; max-height: 550px; overflow-y: auto; padding: 1.75rem 2rem; font-size: 13pt; line-height: 1.6; color: #000000; outline: none; background: #ffffff;" oninput="syncTplContent()">
                    {!! old('html_content', '<div style="text-align: center; margin-bottom: 20px;"><h2>DEPARTMENT OF REVENUE &amp; FORESTS</h2><h3>મહેસૂલ અને વન વિભાગ</h3></div><div style="display: flex; justify-content: space-between; margin-bottom: 20px;"><div><strong>Circular No / પરિપત્ર ક્રમાંક:</strong> [[circular_no]]</div><div style="text-align: right;"><strong>Date / તારીખ:</strong> [[date]]</div></div><p><strong>SUBJECT: [[subject]]</strong></p><p>આથી તમામ કર્મચારીઓને જણાવવામાં આવે છે કે [[details]]</p>') !!}
                </div>
...
<script>
    ...
    // Auto load first field row on start
